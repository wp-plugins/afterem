...
This plugin extends Events Manager to allow follow-up emails to be sent after an event.
...
* Email templating page (html)
* Placeholders are processed by Events Manager (booking, event, and location)
* Send test email (placeholders are not processed)

Visit [AfterEM's Bitbucket page](https://bitbucket.org/gsulibwebmaster/after-em/) to submit issues, contribute to the source code, and to check out the development version of the plugin!
